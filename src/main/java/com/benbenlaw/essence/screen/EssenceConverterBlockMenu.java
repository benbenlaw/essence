...
public class EssenceConverterBlockMenu extends AbstractContainerMenu {
    private final EssenceConverterBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public EssenceConverterBlockMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()),
                new SimpleContainerData(2));
    }

    public EssenceConverterBlockMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.ESSENCE_CONVERTER_BLOCK_MENU.get(), pContainerId);
        checkContainerSize(inv, 4);
        blockEntity = ((EssenceConverterBlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.ESSENCE_CONVERTER_BLOCK.get());
    }
